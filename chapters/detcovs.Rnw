...
If detection probabilities vary among the individuals in a population, CR and SCR models that assume common detection probabilities underestimate abundance. Problem scenario! "biased but apparently precise" also comes up in other contexts.
