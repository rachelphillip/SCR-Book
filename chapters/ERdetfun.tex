...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: secr}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'secr' was built under R version 3.2.5}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# This is secr 2.10.3. For overview type ?secr}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: fields}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'fields' was built under R version 3.2.5}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: spam}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'spam' was built under R version 3.2.5}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: grid}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Spam version 1.4-0 (2016-08-29) is loaded.\\\#\# Type 'help( Spam)' or 'demo( spam)' for a short introduction \\\#\# and overview of this package.\\\#\# Help for individual functions is also obtained by adding the\\\#\# suffix '.spam' to the function name, e.g. 'help( chol.spam)'.}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: package 'maps' was built under R version 3.2.5}}\begin{alltt}
...
\hlstd{knitr}\hlopt{::}\hlkwd{kable}\hlstd{(aics[,}\hlkwd{c}\hlstd{(}\hlstr{"model"}\hlstd{,}\hlstr{"detectfn"}\hlstd{,}\hlstr{"dAICc"}\hlstd{,}\hlstr{"AICcwt"}\hlstd{)])}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{knitr}\hlopt{::}\hlkwd{kable}\hlstd{(}\hlkwd{predict}\hlstd{(er.hr.fit)[,}\hlkwd{c}\hlstd{(}\hlstr{"estimate"}\hlstd{,}\hlstr{"lcl"}\hlstd{,}\hlstr{"ucl"}\hlstd{)])}
\end{alltt}
\end{kframe}
...
\todo[nline]{beginning of interpretation section--subsection?}
...
\todo[inline]{not all models in table shown in text...}Having fitted models with both Gaussian and hazard-rate forms for the encounter rate function and the detection function, we can compare models using AIC$_c$ again:\todo{How to put in neat table?}
{\small
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
