...
\Sexpr{knit_child('chapters/ERdetfun-part3.Rnw')} %DLB
% \Sexpr{knit_child('chapters/spatial-distribution.Rnw')} %DLB
% \Sexpr{knit_child('chapters/detprob-and-spatial.Rnw')}  %DLB
% \Sexpr{knit_child('chapters/explaining-diff-detection.Rnw')} %DLB & EH
% \Sexpr{knit_child('chapters/detector-types.Rnw')}  %Ben
...
\Sexpr{knit_child('chapters/det-types.Rnw')}
